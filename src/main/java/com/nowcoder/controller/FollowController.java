...
public class FollowController {
    ...
    public String followUser(@RequestParam("userId") int userId) {
        ...
        //返回关注的人数
        return WendaUtil.getJSONString(ret?0:1, String.valueOf(followService.getFolloweeCount(hostHolder
                                .getUser().getId(), EntityType.ENTITY_USER)));
    ...
    public String followQuestion(@RequestParam("questionId") int questionId) {
        ...
        Question q = questionService.selectQuestion(questionId);
        if (q == null) {
            WendaUtil.getJSONString(1, "问题不存在！");
        }
